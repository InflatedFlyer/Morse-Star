...
public class TestCustomLua : MonoBehaviour // Rename this class.
{
    ...
    void OnEnable()
    {
        ...
        Lua.RegisterFunction("QuitGame", this, SymbolExtensions.GetMethodInfo(() => QuitGame()));
    }
    ...
    void OnDisable()
    {
        if (unregisterOnDisable)
        {
            ...
            Lua.UnregisterFunction("QuitGame");
        }
    }
