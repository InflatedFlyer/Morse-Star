...
public class BlurEffect : MonoBehaviour
{
    ...
    {
        //着色器实例不为空，就进行参数设置
        if (rawImage!=null&&CurShader != null)
        {
            //【0】参数准备
            ...
            ////清空renderBuffer
            //RenderTexture.ReleaseTemporary(renderBuffer);
            Graphics.Blit(renderBuffer,(RenderTexture)rawImage.texture);
            RenderTexture.ReleaseTemporary(renderBuffer);
        }
    ...
    public void SetBlurArgs(int iter_num,float blur_spread)
    {
        BlurIterations = iter_num;
        BlurSpreadSize = blur_spread;
    }
    #endregion
